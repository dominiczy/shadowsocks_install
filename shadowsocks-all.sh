...
install_dependencies(){
    if check_sys packageManager yum; then
        ...
        yum_depends=(
            unzip gzip openssl openssl-devel gcc python3-devel python3-setuptools pcre pcre-devel libtool libevent
        ...
        apt_depends=(
            gettext build-essential unzip gzip python3-dev python3-setuptools python-is-python3 curl openssl libssl-dev
